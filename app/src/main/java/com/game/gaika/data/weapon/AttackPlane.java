...
public class AttackPlane extends BaseWeapon {
	public AttackPlane(WeaponInfo pWeapInfo) {
		super(pWeapInfo);
		// TODO Auto-generated constructor stub
	}
	public AttackPlane(/*int pId,*/ int pX, int pY, int pExp, int pInfoId, boolean pTeamOut, boolean pSetOut,
					   ID.TEAM_COLOR pTeamColor, boolean pMoveEnding) {
		super(/*pId,*/ pX, pY, pExp, pInfoId, pTeamOut, pSetOut, pTeamColor, pMoveEnding);
		// TODO Auto-generated constructor stub
	}
	public AttackPlane(int pId, int pInfoId, int pX, int pY, boolean pTeamout, boolean pSetout, ID.TEAM_COLOR pTemaColor,
