...
public class TransportShip extends BaseWeapon {
    private List<BaseWeapon> passengers = new ArrayList<BaseWeapon>();
    private boolean showTransportFalg = false;

    public TransportShip(WeaponInfo pWeapInfo) {
        super(pWeapInfo);
        // TODO Auto-generated constructor stub
    }

    public TransportShip(/*int pId,*/ int pX, int pY, int pExp, int pInfoId, boolean pTeamOut, boolean pSetOut,
                         ID.TEAM_COLOR pTeamColor, boolean pMoveEnding) {
        super(/*pId,*/ pX, pY, pExp, pInfoId, pTeamOut, pSetOut, pTeamColor, pMoveEnding);
        // TODO Auto-generated constructor stub
    }

    public TransportShip(int pId, int pInfoId, int pX, int pY, boolean pTeamout, boolean pSetout, ID.TEAM_COLOR pTemaColor,
    ...
    public boolean canTransport(BaseWeapon pWeapon) {
        ...
        if (city != null && city.type == HARBOUR
